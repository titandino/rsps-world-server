...
public class Home {
	...
	public static ObjectClickHandler handleShops = new ObjectClickHandler(new Object[] { 18789 }, WorldTile.of(3095, 3499, 0), e -> {
	...
	public static ObjectClickHandler healingWell = new ObjectClickHandler(new Object[] { 28715 }, WorldTile.of(3080, 3487, 0), e -> {
